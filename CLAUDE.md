...
2. **Check `docker-config.yml`** — if the service has a docker-config section, your compose/template changes need to work in both full-role and docker-config-only contexts
