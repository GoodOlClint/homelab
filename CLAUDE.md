...
**services.yml tags:** `nvidia-licensing`, `docker`, `plex`, `minio`, `squid`, `lancache` (homepage and plex-services moved to the cluster — `make talos-homepage`, `make talos-plex-services`)
