...
**services.yml tags:** `nvidia-licensing`, `docker`, `plex`, `plex-services`, `minio`, `squid`, `mcp`, `lancache` (homepage moved to the cluster — `make talos-homepage`)
