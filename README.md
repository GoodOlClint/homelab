...
| `k8s-apps` | The in-app tail (WP7): jellyfin wizard/LDAP plugin/libraries, arr external auth + SAB whitelist, authentik-ext secrets + blueprint apply, codeintel roles/database/extension — all through the pods' own APIs; second run = 0 changed |
